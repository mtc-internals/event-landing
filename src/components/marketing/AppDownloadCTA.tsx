      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
        <ScrollReveal>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold text-brand">
            ...
            HappnCity mobile app
          </span>
          <h2 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
            Your next event is one tap away
          </h2>
          <p className="mt-4 max-w-md text-text-muted">
            RSVP, buy tickets, get reminders, and check in — the full HappnCity experience lives in the app.
            Launching soon for iOS and Android.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            <span
              aria-disabled
              className="flex cursor-not-allowed items-center gap-2 rounded-xl bg-foreground/60 px-5 py-3 text-sm font-semibold text-background"
            >
            ...
            <span
              aria-disabled
              className="flex cursor-not-allowed items-center gap-2 rounded-xl border border-border-subtle bg-surface-elevated px-5 py-3 text-sm font-semibold text-text-faint"
            >
